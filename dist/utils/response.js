 ...
 */
export function formatChainResponse(response) {
    return {
        content: [
            {
                type: 'text',
 ...
 */
export function formatDiscoveryResponse(response) {
    return {
        content: [
            {
                type: 'text',
 ...
 */
export function formatTextResponse(text, isError = false) {
    return {
        content: [
            {
                type: 'text',
 ...
 */
export function formatDataResponse(data, isError = false) {
 ...
 */
export function formatHttpCraftError(stderr, exitCode, command) {
    return {
        content: [
            {
                type: 'text',
 ...
 */
export function extractHttpCraftError(stderr) {
